...
class Advanced_Mapping extends Action {
	...
	public static function get_name() {
		return 'Advanced data mapping';
	}

	public static function get_description() {
		return 'Map available data to a new data set and define specific value pairs. Use this to transform generic data fields such as incoming webhook or form fields into dynamic data sources that can be used by downstream actions.';
	}
	...
	public function do_action( $data ) {
		...
		if ( $key === false ) {
			...
			//if we dont have a value for the key, we use the initial field value
