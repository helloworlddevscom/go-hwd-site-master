...
class Wordpress_New_Register extends Action {
	...
	public static function get_name(): string {
		return 'Find or create user';
	}

	public static function get_description(): string {
		return 'This action will check if the provided email address matches a user on your site. If not, a user account will be created and will be given the selected user role.';
	}
