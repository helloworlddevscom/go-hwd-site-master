...
class Wordpress_Update_User extends Wordpress_New_Register {
	...
	public static function get_description(): string {
		return 'This action will find a user with the provided email address and update their account details. If there is no email match, the action will be skipped. If the user’s role does not have custom fields, their data will be ignored.';
	}
