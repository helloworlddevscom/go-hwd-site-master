...
class TAP_DB_Manager {
	...
	public function display_admin_error() {
		...
		echo '<div class="notice notice-error is-dismissible"><p>' .
		     sprintf(
			     'There was an error while updating the database tables%s. Detailed error message: %s. If you continue seeing this message, please contact %s',
			     $this->_product_name ? " ({$this->_product_name})" : '',
			     '<strong>' . $this->_last_db_error . '</strong>',
			     '<a target="_blank" href="https://thrivethemes.com/forums/">' . 'Thrive Themes Support' . '</a>'
		     ) .
		     '</p></div>';
