...
class Error_Log_Handler {
	 ...
	 */
	public static $available_intervals = [
		'7'   => [
			'label' => 'Last 7 days',
			'key'   => 7,
		],
	 ...
	 * @return array
	 */
	public static function get_error_log( $id, $interval = 'all', $page = 1 ) {
		$sql_interval = '';
	 ...
	 * @return bool
	 */
	public static function save_log_settings( $settings ) {
	 ...
	 * @return string
	 */
	public function get_nice_class_name( $class ) {
...
function tap_logger( $automation_id = 0 ) {
