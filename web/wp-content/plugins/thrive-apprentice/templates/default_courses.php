						...
						'lessons' => array(
							array(
								'args'         => array(
									...
									'post_content' => __( 'To start with, we’ll take a look at some proof. That way, you’ll see that the recipes in this course actually work (and produce some impressive results) in the real world and aren’t just marketing theory.', TVA_Const::T ),
									'post_status'  => 'publish',
								),
								'lesson_type'  => 'text',
								'lesson_order' => 0,
							...
							array(
								'args'         => array(
									...
									'post_content' => __( 'In this lesson, we introduce the concept of scarcity marketing. And very importantly: we look at some examples of how not to do it and the principles for doing it right. Scarcity marketing is tricky in this regard. If you do it right, it’s incredibly powerful. But if you do it wrong, it can cost you dearly and damage your reputation.', TVA_Const::T ),
									'post_status'  => 'publish',
								),
								'lesson_type'  => 'text',
								'lesson_order' => 1,
							...
							array(
								'args'         => array(
									'post_title'   => __( 'How to Build Courses With Thrive Apprentice', TVA_Const::T ),
									'post_type'    => TVA_Const::LESSON_POST_TYPE,
									'post_excerpt' => __( 'In this lesson, we introduce the concept of scarcity marketing. And very importantly: we look at some examples of how not to do it and the principles for doing it right. Scarcity marketing is tricky in this regard. If you do it right, it’s incredibly powerful. But if you do it wrong, it can cost you dearly and damage your reputation.', TVA_Const::T ),
									'post_content' => __( 'In this lesson, we introduce the concept of scarcity marketing. And very importantly: we look at some examples of how not to do it and the principles for doing it right. Scarcity marketing is tricky in this regard. If you do it right, it’s incredibly powerful. But if you do it wrong, it can cost you dearly and damage your reputation.', TVA_Const::T ),
									'post_status'  => 'publish',
							...
							array(
								'args'         => array(
									'post_title'   => __( 'How to Build a Digital Product Empire', TVA_Const::T ),
									'post_type'    => TVA_Const::LESSON_POST_TYPE,
									'post_excerpt' => __( 'In this lesson, we introduce the concept of scarcity marketing. And very importantly: we look at some examples of how not to do it and the principles for doing it right. Scarcity marketing is tricky in this regard. If you do it right, it’s incredibly powerful. But if you do it wrong, it can cost you dearly and damage your reputation.', TVA_Const::T ),
									'post_content' => __( 'In this lesson, we introduce the concept of scarcity marketing. And very importantly: we look at some examples of how not to do it and the principles for doing it right. Scarcity marketing is tricky in this regard. If you do it right, it’s incredibly powerful. But if you do it wrong, it can cost you dearly and damage your reputation.', TVA_Const::T ),
									'post_status'  => 'publish',
				...
				'lessons' => array(
					...
					array(
						'args'         => array(
							...
							'post_content' => __( 'In this short lesson, we introduce two recipes you can apply to your business: the “under the radar” promotion and the classic product launch or sale. You’ll see the exact steps and timings required to make these promotions as effective as possible.', TVA_Const::T ),
							'post_status'  => 'publish',
						),
						'lesson_type'  => 'text',
						'lesson_order' => 1,
		...
		'lessons'      => array(
			array(
				'args'         => array(
					...
					'post_content' => __( 'Why is it so hard to create engaging content? And what is engaging content actually? Discover what you’ll need to learn in order to make your content marketing efficient', TVA_Const::T ),
					'post_status'  => 'publish',
				),
				'lesson_type'  => 'text',
				'lesson_order' => 0,
			...
			array(
				'args'         => array(
					...
					'post_content' => __( 'Over two million blog articles are written every day. And most of them will never be read. Discover why this happens and how to avoid being part of this junkyard of internet rubbish.', TVA_Const::T ),
					'post_status'  => 'publish',
				),
				'lesson_type'  => 'text',
				'lesson_order' => 1,
			...
			array(
				'args'         => array(
					...
					'post_content' => __( 'Check these 4 things before publishing any content online. If you get one of these wrong, the actual content of your blog will not even matter all that much…', TVA_Const::T ),
					'post_status'  => 'publish',
				),
				'lesson_type'  => 'text',
				'lesson_order' => 2,
