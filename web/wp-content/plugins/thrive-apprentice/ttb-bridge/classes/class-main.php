...
class Main {
	...
	protected static function includes() {
		...
		require_once __DIR__ . '/class-default-data.php';
		require_once __DIR__ . '/class-apprentice-wizard.php';
		require_once __DIR__ . '/class-skin.php';
		require_once __DIR__ . '/class-palette.php';
		require_once __DIR__ . '/class-skin-template.php';
		require_once __DIR__ . '/class-legacy-skin.php';
		require_once __DIR__ . '/class-reset.php';

		/* REST controllers extending from the theme */
		require \TVA_Const::plugin_path( 'inc/classes/endpoints/class-tva-wizard-controller.php' );
	}
	...
	public static function get_active_template() {
		...
		} else if ( get_post_type() === THRIVE_TEMPLATE ) {
			$template_id = get_the_ID();
		} else if ( static::uses_builder_templates() && ( tva_is_apprentice() || tva_general_post_is_apprentice() ) ) {
...
//				var_dump( 'Investigate here!' );

//				var_dump( thrive_skin()->ID, static::get_default_skin_id() );
//				var_dump( $meta );
