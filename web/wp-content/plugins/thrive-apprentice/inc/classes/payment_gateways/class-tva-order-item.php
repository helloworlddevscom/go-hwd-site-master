...
class TVA_Order_Item {
	...
	public function set_product_id( $product_id ) {
		...
		$this->product_id = \TVA\Product_Migration::validate_product_id( $product_id );

		/**
		 * We need to invalidate cache on a new purchase
		 */
		TVA_Course_V2::delete_count_enrolled_users_cache( 0 );
		\TVA\Product::delete_count_users_with_access_cache( $this->product_id );
	}
	 ...
	 * @return string
	 */
	public function get_access_type( $order, $sendowl_product_ids = array(), $wc_product = null ) {
