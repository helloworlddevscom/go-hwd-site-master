...
class Repeating extends Non_Repeating {
	...
	public static function get_daily_options() {
		...
		return array_merge( $values, [
			[ 'value' => 'weekday', 'label' => __( 'Only on weekdays', \TVA_Const::T ) ],
			[ 'value' => 'weekend', 'label' => __( 'Only over the weekend', \TVA_Const::T ) ],
		] );
	}
	...
	public static function get_interval_options() {
		return [
			[ 'value' => 'days', 'label' => __( 'Daily', \TVA_Const::T ) ],
			[ 'value' => 'weeks', 'label' => __( 'Weekly', \TVA_Const::T ) ],
			[ 'value' => 'months', 'label' => __( 'Monthly', \TVA_Const::T ) ],
		];
	}
}
