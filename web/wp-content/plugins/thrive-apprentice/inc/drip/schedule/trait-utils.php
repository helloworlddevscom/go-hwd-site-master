...
trait Utils {
	 ...
	 * @return bool
	 */
	protected function is_past( $test_date, $reference_date = null ) {
	...
	public static function get_weekdays( $include_any = false, $assoc = false ) {
		$days = [];
		if ( $include_any ) {
			$days [] = [ 'value' => '-1', 'label' => __( 'Any', \TVA_Const::T ) ];
		}

		$days[] = [ 'value' => '0', 'label' => __( 'Sunday', \TVA_Const::T ) ];
		$days[] = [ 'value' => '1', 'label' => __( 'Monday', \TVA_Const::T ) ];
		$days[] = [ 'value' => '2', 'label' => __( 'Tuesday', \TVA_Const::T ) ];
		$days[] = [ 'value' => '3', 'label' => __( 'Wednesday', \TVA_Const::T ) ];
		$days[] = [ 'value' => '4', 'label' => __( 'Thursday', \TVA_Const::T ) ];
		$days[] = [ 'value' => '5', 'label' => __( 'Friday', \TVA_Const::T ) ];
		$days[] = [ 'value' => '6', 'label' => __( 'Saturday', \TVA_Const::T ) ];
	...
	public static function get_monthly_schedule_options() {
		return [
			[ 'value' => 'any', 'label' => __( 'Any', \TVA_Const::T ) ],
			[ 'value' => 'date', 'label' => __( 'On a specific date (e.g day 21)', \TVA_Const::T ) ],
			[ 'value' => 'day', 'label' => __( 'On a specific day of the month (e.g first Monday in the month)', \TVA_Const::T ) ],
		];
	}
	...
	public static function get_monthly_order_options() {
		return [
			[ 'value' => 'first', 'label' => __( 'First', \TVA_Const::T ) ],
			[ 'value' => 'second', 'label' => __( 'Second', \TVA_Const::T ) ],
			[ 'value' => 'third', 'label' => __( 'Third', \TVA_Const::T ) ],
			[ 'value' => 'fourth', 'label' => __( 'Fourth', \TVA_Const::T ) ],
			[ 'value' => 'last', 'label' => __( 'Last', \TVA_Const::T ) ],
		];
	}
}
