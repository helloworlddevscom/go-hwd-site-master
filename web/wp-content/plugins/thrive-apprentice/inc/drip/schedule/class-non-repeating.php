...
class Non_Repeating extends Base {
	...
	public static function get_interval_options() {
		return [
			[ 'value' => 'hours', 'label' => __( 'Hour(s)', \TVA_Const::T ) ],
			[ 'value' => 'days', 'label' => __( 'Day(s)', \TVA_Const::T ) ],
			[ 'value' => 'weeks', 'label' => __( 'Week(s)', \TVA_Const::T ) ],
			[ 'value' => 'months', 'label' => __( 'Month(s)', \TVA_Const::T ) ],
		];
	}
}
