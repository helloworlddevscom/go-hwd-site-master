...
require_once plugin_dir_path( __FILE__ ) . 'schedule/trait-utils.php';
require plugin_dir_path( __FILE__ ) . 'schedule/class-base.php';
require plugin_dir_path( __FILE__ ) . 'schedule/class-specific.php';
require plugin_dir_path( __FILE__ ) . 'schedule/class-non-repeating.php';
require plugin_dir_path( __FILE__ ) . 'schedule/class-repeating.php';
require plugin_dir_path( __FILE__ ) . 'triggers/class-base.php';
require plugin_dir_path( __FILE__ ) . 'triggers/class-specific-date-time-interval.php';
require plugin_dir_path( __FILE__ ) . 'triggers/class-time-after-first-lesson.php';
require plugin_dir_path( __FILE__ ) . 'triggers/class-time-after-purchase.php';
require plugin_dir_path( __FILE__ ) . 'triggers/class-automator.php';
require plugin_dir_path( __FILE__ ) . 'triggers/class-course-content.php';
require \TVA_Const::plugin_path( '/tqb-bridge/classes/class-drip-result-trigger.php' );

require dirname( __FILE__ ) . '/campaign.php';
require plugin_dir_path( __FILE__ ) . 'class-drip.php';
