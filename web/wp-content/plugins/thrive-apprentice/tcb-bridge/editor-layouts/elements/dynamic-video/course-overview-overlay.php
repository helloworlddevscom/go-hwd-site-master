...
<div class="tve_responsive_video-no_video">
	...
	<span class="tva-dynamic-video-label"><?php echo esc_html__( 'This video element will only show on courses where you have enabled a video description.', TVA_Const::T ); ?></span>
</div>
