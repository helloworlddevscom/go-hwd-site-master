...
<div id="tve-course_list-component" class="tve-component" data-view="CourseList">
	<div class="dropdown-header" data-prop="docked">
		<?php echo __( 'Course List Options', TVA_Const::T ); ?>
		<i></i>
	</div>
	<div class="dropdown-content">
		<div class="row sep-bottom tcb-text-center post-list-actions">
			<div class="col-xs-12">
				<button class="tve-button orange click" data-fn="courseListEditMode"><?php echo __( 'Edit Design', TVA_Const::T ); ?></button>
				<button class="tve-button grey click margin-left-20 tcb-relative" data-fn="filterPosts"><?php echo __( 'Filter Courses', TVA_Const::T ); ?></button>
			</div>
		</div>
		...
		<div class="info-text orange hide-tablet hide-mobile">
			<?php echo __( 'This option disables all animations for this element and all child link options', TVA_Const::T ); ?>
		</div>
		<div class="tve-advanced-controls extend-grey mt-5">
			<div class="dropdown-header" data-prop="advanced">
				<span><?php echo __( 'Advanced', TVA_Const::T ); ?></span>
			</div>
			<div class="dropdown-content pt-0">
				<?php echo __( 'No results message', TVA_Const::T ); ?>
				<textarea id="tva-course-list-no-courses-message" class="mt-5 mb-5 change" data-fn="changeNoCoursesMessage" placeholder="<?php echo esc_attr__( 'Message that appears when no courses are found', TVA_Const::T ); ?>"></textarea>
