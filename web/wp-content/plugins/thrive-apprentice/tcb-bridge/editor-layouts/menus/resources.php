...
<div id="tve-resources-component" class="tve-component" data-view="Resources">
	...
	<div class="dropdown-content">
		...
		<div class="info-text mb-10 course-unpublished">
			<?php echo __( 'This course is currently not published. For your customers to view the resources of this lesson it must be published', TVA_Const::T ); ?>
			<a href="#" target="_blank"><?php echo __( 'here.', TVA_Const::T ); ?></a>
		</div>
		<div class="info-text mb-10 lesson-unpublished">
			<?php echo __( 'Lesson not published: This lesson is currently not published. For your customers to view the resources of this lesson it must be published', TVA_Const::T ); ?>
			<a href="#" target="_blank"><?php echo __( 'here.', TVA_Const::T ); ?></a>
		</div>
		<div class="info-text mb-10 orange no-resources">
			<?php echo __( 'No resources found: Add resources to this lesson in Thrive Apprentice.', TVA_Const::T ); ?>
			<a href="//help.thrivethemes.com/en/articles/4933179-attach-downloadable-files-to-your-lesson-s-content-in-thrive-apprentice" target="_blank"><?php echo __( 'Learn more.', TVA_Const::T ); ?></a>
		</div>
