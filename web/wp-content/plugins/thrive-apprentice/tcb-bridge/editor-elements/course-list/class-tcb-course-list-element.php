...
class TCB_Course_List_Element extends TCB_Post_List_Element {
	...
	public function name() {
		return __( 'Course List', TVA_Const::T );
	}
	...
	public function elements_group_label() {
		return __( 'Course List Elements', TVA_Const::T );
	}
	...
	public function own_components() {
		...
		$components['course_list']['config'] = array_merge( $components['course_list']['config'], array(
			'TopicFilter'  => array(
				'config'  => array(
					'name'  => '',
					'label' => __( 'Display topic filter', TVA_Const::T ),
				),
				'extends' => 'Switch',
			),
			'CourseSearch' => array(
				'config'  => array(
					'name'  => '',
					'label' => __( 'Display course search', TVA_Const::T ),
				),
				'extends' => 'Switch',
			),
			'MessageColor' => array(
		...
		//Change some labels
		$components['course_list']['config']['Linker']['config']['label'] = __( 'Link entire item to course', TVA_Const::T );
