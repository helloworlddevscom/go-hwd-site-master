		...
		$components['course_list_dropdown']['config'] = array_merge( $components['course_list_dropdown']['config'], array(
			'RowsWhenOpen'                 => array(
				'config'  => array(
					'min'   => 1,
					'max'   => 15,
					'label' => __( 'Rows when open', TVA_Const::T ),
					'um'    => array(),
				),
				'extends' => 'Slider',
			),
			...
			'FilterRestrictions'           => array(
				'config'  => array(
					'name'  => '',
					'label' => __( 'Access restrictions', TVA_Const::T ),
				),
				'extends' => 'Switch',
			),
			...
			'FilterProgress'               => array(
				'config'  => array(
					'name'        => '',
					'label'       => __( 'My courses (progress)', TVA_Const::T ),
					'info'        => true,
					'icontooltip' => __( 'These options will only be available to users who are logged in', TVA_Const::T ),
					'iconside'    => 'top',
				),
				'extends' => 'Switch',
			),
			'FilterProgressSubheading'     => array(
				'config'  => array(
					'label' => __( 'My courses', TVA_Const::T ),
				),
				'extends' => 'LabelInput',
			),
		) );
