...
class TCB_Course_Element extends TCB_Cloud_Template_Element_Abstract {
	...
	public function elements_group_label() {
		return __( 'Lesson List Elements', TVA_Const::T );
	}
			...
			'course'           => array(
				'config' => array(
					...
					'ToggleModule'        => array(
						'config'  => array(
							'name'  => '',
							'label' => __( 'Hide module header', \TVA_Const::T ),
						),
						'extends' => 'Switch',
					),
					'Palettes'            => array(
					...
					'AutoCollapse'        => array(
						'config'  => array(
							'name'        => '',
							'label'       => __( 'Auto collapse', TVA_Const::T ),
							'info'        => true,
							'icontooltip' => __( 'Auto collapse will automatically collapse modules & chapters that are not associated with the active lesson', TVA_Const::T ),
							'iconside'    => 'top',
						),
						'extends' => 'Switch',
					),
					'AutoCourseStructure' => array(
						'config'  => array(
							'name'  => '',
							'label' => __( 'Display entire course structure', TVA_Const::T ),
						),
						'extends' => 'Switch',
					),
				),
