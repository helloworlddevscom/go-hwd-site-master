...
class TCB_Resources_Element extends TCB_Cloud_Template_Element_Abstract {
	...
	public function name() {
		return __( 'Lesson Resources', TVA_Const::T );
	}
	...
	public function html() {
		...
		return tcb_template(
			...
			array(
				...
				'title' => __( 'Insert Apprentice Resources', TVA_Const::T ),
			),
			true
		);
	}
			...
			'resources'  => [
				'config' => [
					...
					'showIcons'        => [
						'config'  => [
							'name'  => '',
							'label' => __( 'File type icon', TVA_Const::T ),
						],
						'extends' => 'Switch',
					],
					'showDescriptions' => [
						'config'  => [
							'name'  => '',
							'label' => __( 'Description', TVA_Const::T ),
						],
						'extends' => 'Switch',
					],
					'showDownload'     => [
						'config'  => [
							'name'  => '',
							'label' => __( 'Download button', TVA_Const::T ),
						],
						'extends' => 'Switch',
					],
					'IconAlign'        => [
						'config'  => [
							'name'      => __( 'Icons vertical position', TVA_Const::T ),
							'important' => true,
							'buttons'   => [
								[
									'icon'  => 'top',
					...
					'ButtonAlign'      => [
						'config'  => [
							'name'      => __( 'Buttons vertical position', TVA_Const::T ),
							'important' => true,
							'buttons'   => [
								[
									'icon'  => 'top',
		...
		return [
			'select_values' => [
				[
					...
					'name'      => __( 'Resource item', TVA_Const::T ),
					'singular'  => __( '-- Resource item %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_download',
					'selector'  => '.tva-resource-button.tva-res-download',
					'name'      => __( 'Download buttons', TVA_Const::T ),
					'singular'  => __( '-- Download button %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_open',
					'selector'  => '.tva-resource-button.tva-res-open',
					'name'      => __( 'Open buttons', TVA_Const::T ),
					'singular'  => __( '-- Open button %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_icons',
					'selector'  => '.tva-resource-icon',
					'name'      => __( 'Icons', TVA_Const::T ),
					'singular'  => __( '-- Icon %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_download_icons',
					'selector'  => ' .tva-res-download .thrv_icon',
					'name'      => __( 'Download button icons', TVA_Const::T ),
					'singular'  => __( '-- Download button icon %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_open_icons',
					'selector'  => ' .tva-res-open .thrv_icon',
					'name'      => __( 'Open button icons', TVA_Const::T ),
					'singular'  => __( '-- Open button icon %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_titles',
					'selector'  => '.tva-resource-title',
					'name'      => __( 'Resource titles', TVA_Const::T ),
					'singular'  => __( '-- Resource title %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_descriptions',
					'selector'  => '.tva-resource-description',
					'name'      => __( 'Resource descriptions', TVA_Const::T ),
					'singular'  => __( '-- Resource description %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_text_containers',
					'selector'  => '.tva-resource-details',
					'name'      => __( 'Resource text containers', TVA_Const::T ),
					'singular'  => __( '-- Resource text container %s', TVA_Const::T ),
					'no_unlock' => true,
				],
				[
					'value'     => 'all_button_containers',
					'selector'  => '.tva-resource-get',
					'name'      => __( 'Resource button containers', TVA_Const::T ),
					'singular'  => __( '-- Resource button container %s', TVA_Const::T ),
					'no_unlock' => true,
				],
			],
		];
