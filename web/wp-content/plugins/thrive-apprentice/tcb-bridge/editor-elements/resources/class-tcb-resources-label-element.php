						...
						'config'  => array(
							'buttons' => array(
								array(
									...
									'text'    => __( 'Font Size', TVA_Const::T ),
									'default' => true,
								),
								array(
									'value' => 'tcb-typography-line-height',
									'text'  => __( 'Line Height', TVA_Const::T ),
								),
								array(
									'value' => 'tcb-typography-letter-spacing',
									'text'  => __( 'Letter Spacing', TVA_Const::T ),
								),
							),
						),
						'extends' => 'ButtonGroup',
