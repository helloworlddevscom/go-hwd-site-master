...
class Dropdown {
	...
	private function default_args() {
		return array(
			'style'                   => 'default',
			'icon'                    => 'style_1',
			'placeholder'             => esc_attr__( 'All courses...', \TVA_Const::T ),
			'css'                     => substr( uniqid( 'tve-u-', true ), 0, 17 ),
			'topics-subheading'       => esc_attr__( 'Topics', \TVA_Const::T ),
			'restrictions-subheading' => esc_attr__( 'Access restrictions', \TVA_Const::T ),
			'progress-subheading'     => esc_attr__( 'My courses', \TVA_Const::T ),
			'filter-topics'           => '1',
...
tcb_course_list_dropdown_shortcode();
