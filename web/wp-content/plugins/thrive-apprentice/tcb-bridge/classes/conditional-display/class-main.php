...
class Main {
	...
	public static function exclude_post_types( $excluded_post_types ) {
		array_push( $excluded_post_types, \TVA_Const::MODULE_POST_TYPE, \TVA_Const::LESSON_POST_TYPE, \TVA_Const::CHAPTER_POST_TYPE, \TVA_Course_Overview_Post::POST_TYPE );
	...
	public static function set_query_vars_data() {
		...
		( new \TVA\Architect\Visual_Builder\Hooks() )->set_objects();
	}
