...
class TVA_Admin {
	...
	public function enqueue_scripts( $screen_id ) {
		...
		if ( static::$can_run ) {
			 ...
			 */
			wp_add_inline_style( 'thrive-admin-apprentice', ':root{' . \TVA\TTB\Main::requested_skin()->css( true ) . '}' );
	...
	public function get_localize_data() {
		...
		return array(
			...
			'access_debug'         => \TVA\Product_Migration::is_debug_on(),
			...
			'visualEditingEnabled' => \TVA\TTB\Main::uses_builder_templates(),
		);
	}
