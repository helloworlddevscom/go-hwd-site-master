...
<div class="tva-notice-modal-outer tve-ult-notice-overlay">
	<div id="tve_ult_license_notice" class="tva-notice-modal-inner">
		...
		<p>
			<?php echo __( "It looks like you have an old version of WordPress installed, but it's not compatible with this version of Thrive Apprentice. Thrive Apprentice uses WordPress functionality which is not available in versions earlier than 4.6. To be able to use this feature, please make sure you have the at least version 4.6 installed:", TVA_Const::T ); ?>
		</p>
