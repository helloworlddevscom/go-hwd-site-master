...
class Start_Campaign_Id_Field extends \Thrive\Automator\Items\Action_Field {
	...
	public static function get_name() {
		return __( 'Running campaign', \TVE_Ult_Const::T );
	}
	...
	public static function get_description() {
		return __( 'Which lockdown campaign do you want to trigger?', \TVE_Ult_Const::T );
	}
	...
	public static function get_placeholder() {
		return __( 'Choose campaign', \TVE_Ult_Const::T );
	}
