...
class Campaign_Event_Id_Data_Field extends \Thrive\Automator\Items\Data_Field {
	...
	public static function get_name() {
		return __( 'ID of the event that triggered the countdown', \TVE_Ult_Const::T );
	}
	...
	public static function get_description() {
		return __( 'User targets by the specific event ID that triggered the campaign', \TVE_Ult_Const::T );
	}
