		...
		return array(
			'quiz'             => array(
				'config' => array(
					'change_quiz'          => array(
						'config'  => array(
							'name'        => esc_html__( 'Change quiz', Thrive_Quiz_Builder::T ),
							'label_col_x' => 4,
							'options'     => array(),
						),
						'extends' => 'Select',
					...
					'quiz_scroll'          => array(
						'config'     => array(
							'name'    => '',
							'label'   => esc_html__( 'Enable quiz scroll', Thrive_Quiz_Builder::T ),
							'default' => true,
						),
						'css_suffix' => '',
						'css_prefix' => '',
					...
					'SaveUserQuizProgress' => [
						'config'  => [
							'name'        => '',
							'label'       => esc_html__( 'Save users quiz progress', Thrive_Quiz_Builder::T ),
							'default'     => true,
							'info'        => true,
							'icontooltip' => esc_html__( 'This will allow logged-in users to return to the same page and resume their progress or see their results.', Thrive_Quiz_Builder::T ),
							'iconside'    => 'bottom',
						],
						'extends' => 'Switch',
					],
