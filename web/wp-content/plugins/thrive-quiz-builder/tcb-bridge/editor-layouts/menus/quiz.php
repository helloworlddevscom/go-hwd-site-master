	...
	<div class="dropdown-content">
		...
		<div class="tve-advanced-controls extend-grey tqb-redirection-override">
			<div class="dropdown-header" data-prop="advanced">
				<span><?php esc_html_e( 'Redirection override', Thrive_Quiz_Builder::T ); ?></span>
			</div>
			<div class="dropdown-content pt-0">
				<div>
					<span><?php esc_html_e( 'Automatic redirection is disabled when saving the users quiz progress. Users will be shown a link to their results', Thrive_Quiz_Builder::T ); ?></span>
				</div>
				<hr class="mt-5 mb-5">
