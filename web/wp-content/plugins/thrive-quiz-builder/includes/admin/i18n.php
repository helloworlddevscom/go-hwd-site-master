...
return array(
	...
	'quiz_type_text_survey'              => __( "The participant in this quiz type doesn't receive a specific result. Instead the results page contains the same content for everyone.", Thrive_Quiz_Builder::T ),
	...
	'quiz_type_label_survey'             => __( 'Survey', Thrive_Quiz_Builder::T ),
	...
	'export_quiz'                        => __( 'Exporting Quiz', Thrive_Quiz_Builder::T ),
	'invalid_import_file'                => __( 'Please choose a zip file', Thrive_Quiz_Builder::T ),
	'unavailableBadgeTitle'              => __( 'Social share functionality disabled.', Thrive_Quiz_Builder::T ),
	'unavailableBadge'                   => __( 'Users don\'t receive a specific result in a survey quiz so social sharing for this quiz type is disabled', Thrive_Quiz_Builder::T ),
	'error_fetching_quizzes'             => esc_html__( 'There was an error fetching quizzes. Please check error.logs with your host!', Thrive_Quiz_Builder::T ),
	'pages'                              => __( 'Pages', Thrive_Quiz_Builder::T ),
	'lessons'                            => __( 'Lessons', Thrive_Quiz_Builder::T ),
	'modules'                            => __( 'Modules', Thrive_Quiz_Builder::T ),
	'posts'                              => __( 'Posts', Thrive_Quiz_Builder::T ),
	'course_overviews'                   => __( 'Course overviews', Thrive_Quiz_Builder::T ),
	'products'                           => __( 'Products', Thrive_Quiz_Builder::T ),
	'min_one_selected'                   => __( 'At least one option must be selected', Thrive_Quiz_Builder::T ),
	'min_one_category_selected'          => __( 'At least one quiz category needs to be selected', Thrive_Quiz_Builder::T ),
	'numeric_general_error'              => __( 'Values must be a number higher than the minimum and lower than the maximum result!', Thrive_Quiz_Builder::T ),
	'date_not_selected'                  => __( 'Please select a date!', Thrive_Quiz_Builder::T ),
	'invalid_date_interval'              => __( 'Please provide a valid date interval!', Thrive_Quiz_Builder::T ),
	'location_unavailable'               => __( 'Location filter can be used per specific quiz.', Thrive_Quiz_Builder::T ),
);
